...
## team work
watch this: successful team traits study by [google](https://youtu.be/hHIikHJV9fI)
...
agile is a set of values and principles, it's a collection of beleifs that team can use to make decisions about how to do the work of developing software, a team who take decision that match with the team principles and values are agile
...
![ef76e3804a3f272a228254a7d126070c28eb2b25](https://github.com/user-attachments/assets/9ec0e3e4-80c6-421b-8fa4-58e23da8071b)

## Benefits of agile team
1. **Faster time-to-market**: Agile teams can deliver working software in short iterations, allowing organizations to respond quickly to changing market conditions, customer needs and feedback. One way to do it is to build a Minimum Viable Product (MVP). An MVP is a simple, first version of a product or app that has just enough features to solve a specific problem and gather feedback from users. It’s like a basic model of a car that lets you drive and get feedback before adding more fancy features such as air conditioning, heated seats etc
2. **Increased collaboration**: Agile teams work closely together, breaking down silos and fostering better communication and collaboration between team members. This means that these teams can often work more independently to find solutions and produce results faster
3. **Higher quality**:Agile methodology emphasizes testing and feedback, allowing teams to catch and fix defects earlier in the development process. This iterative method means that the output is more stable and functional.
4. **Flexibility**: Agile methodology is adaptable to changes in project requirements, allowing teams to pivot and adjust their approach as needed. Since the team consists of a diverse set of talents, it often doesn’t have to wait for another department or team to get involved and can resolve issues on its own.
...
read the [manifesto](https://agilemanifesto.org/)
...
### difference between traditional team and agile team
![3d8052b40268196a5fdd8ae9293a2eefb6731a15](https://github.com/user-attachments/assets/b6cbd176-bf86-4660-85db-0e0f256eea4f)
...
### sprint planning and meetings and retros
